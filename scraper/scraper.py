...
# ── Canales fijos — logos desde fuentes que no bloquean ──────────────────
CANALES_FIJOS = [
    # ── AIRE ──────────────────────────────────────────────────────────────
    {
    ...
    {
        "id": "c07", "nombre": "Cine.AR", "categoria": "AIRE",
        "url": "https://www.youtube-nocookie.com/embed/live_stream?channel=UCgEHKNOTG6G2gy1x0j2bKrw&autoplay=1",
        "logo": "https://i.imgur.com/RPLyrIC.png",
        "fallbacks": [],
    },
    {
        "id": "c08", "nombre": "Argentinísima", "categoria": "AIRE",
    ...
    {
        "id": "c13", "nombre": "DAZN Combat", "categoria": "DEPORTES",
    ...
    {
        "id": "c14", "nombre": "Alkass One", "categoria": "DEPORTES",
    ...
    # ── NOTICIAS ──────────────────────────────────────────────────────────
    {
        "id": "c17", "nombre": "TN", "categoria": "NOTICIAS",
    ...
    # ── MUSICA ────────────────────────────────────────────────────────────
    {
        "id": "c24", "nombre": "Cumbia Mix", "categoria": "MUSICA",
    ...
    {
        "id": "c25", "nombre": "Beats Radio", "categoria": "MUSICA",
    ...
    # ── INFANTIL ──────────────────────────────────────────────────────────
    {
        "id": "c26", "nombre": "Pakapaka", "categoria": "INFANTIL",
    ...
    {
        "id": "c27", "nombre": "Cartoon Network", "categoria": "INFANTIL",
        "url": "https://www.youtube-nocookie.com/embed/live_stream?channel=UCJFp8uSYCjXe9ibGCPXFMQg&autoplay=1",
        "logo": "https://i.imgur.com/placeholder.png",
        "fallbacks": [],
    },
]
...
def verificar_url(url, timeout=5):
    if "youtube" in url or "embed" in url or "nocookie" in url:
        return True
    try:
